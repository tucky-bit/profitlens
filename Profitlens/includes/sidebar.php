...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="system_reset.php" class="nav-item nav-item-danger <?= $current_page == 'system_reset.php' ? 'active' : '' ?>">
...
/* System Reset nav item — subtle red accent so it stands out as a sensitive tool */
.nav-item-danger {
